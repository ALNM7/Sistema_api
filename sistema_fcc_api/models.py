...
#aqui se colocan las tblas que apareceran en la base de datos de php my admin
    #aqui se incluye el atributo y el tipo de dato 
...
class Maestros(models.Model):
    ...
    def __str__(self):
        return "Perfil Maestro "+self.first_name+" "+self.last_name
