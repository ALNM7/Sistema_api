...
#Se crea una peticion get en esta clase para imprimir la tabla de los usuarios y mostrar su info
#Solicita tambien el token de inicio de sesion
class AdminAll(generics.CreateAPIView):
    permission_classes = (permissions.IsAuthenticated,)# <- Solicita el token esta linea
